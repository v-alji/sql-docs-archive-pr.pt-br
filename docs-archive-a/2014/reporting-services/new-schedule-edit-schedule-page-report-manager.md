...
-   **Dia** define uma agenda que é executada nos dias que você seleciona, em uma hora e minuto específicos. Você pode especificar dias das seguintes maneiras: cada, todos os dias da \<*day*> semana e todos os \<*number*> dias. A escolha de uma abordagem invalida as outras, mesmo se os outros dias parecem selecionados.  
