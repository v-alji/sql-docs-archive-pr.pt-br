...
1.  Clique em **Iniciar**, aponte para **programas**, clique em [!INCLUDE[ssCurrentUI](../includes/sscurrentui-md.md)] **Construtor de relatórios**e, em seguida, clique em **Construtor de relatórios**.  
...
13. Na lista **valores** , clique com o botão direito do mouse `CountryRegionID` e clique na opção **soma** .  
...
##  <a name="6-count-days-since-last-purchase"></a><a name="Count"></a>6. contagem de dias desde a última compra  
 Adicione uma coluna e, em seguida, use a função **Now** ou a `ExecutionTime` variável global interna para calcular o número de dias a partir de hoje desde a última compra de uma pessoa.  
