 ...
 **Instalação:** O Report Manager é instalado quando você instala o [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] modo nativo: [instalar Reporting Services servidor de relatório no modo nativo](../install-windows/install-reporting-services-native-mode-report-server.md)  
...
1.  No tipo de tela inicial do Windows `sql server` e nos resultados da pesquisa de **aplicativos** , clique em **SQL Server Management Studio**.  
...
1.  Na tela inicial do Windows, digite **data** e, nos resultados da pesquisa de **Aplicativos** , clique em **SQL Server Data Tools para Visual Studio 2012**.  
     ...
     **Or**  
     ...
     Clique em **Iniciar**, aponte para **todos os programas**, aponte para [!INCLUDE[ssCurrentUI](../../../includes/sscurrentui-md.md)] e clique em **SQL Server Data Tools (SSDT)**.  
