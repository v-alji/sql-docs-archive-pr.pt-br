...
## <a name="tools-for-report-content-management"></a>Ferramentas para gerenciamento de conteúdo de relatório  
 Um conjunto de ferramentas gráficas e de script está disponível para gerenciar conteúdo no [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] . As ferramentas que você usa dependem do modo de implantação de seu servidor de relatório.  
