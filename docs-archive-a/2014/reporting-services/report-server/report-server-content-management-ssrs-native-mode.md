...
> [!NOTE]
>  O gerenciamento de conteúdo é diferente da administração de servidor de relatório. Para obter mais informações sobre como gerenciar o ambiente em que um servidor de relatório é executado, consulte [Servidor de relatório do Reporting Services &#40;Modo Nativo&#41;](reporting-services-report-server-native-mode.md).
...
|![Ícone da fonte de dados compartilhada](../media/hlp-16datasource.png "Ícone da fonte de dados compartilhada")|Fonte de dados compartilhada|
...
|@ (símbolo de arroba)|[arroba]|*nome de usuário* @hotmail.com torna-se o *nome de usuário*[at] hotmail. com|
|& (e comercial)|[E comercial]|*nome de usuário* @ *empresa* & *Company.com* torna-se o *nome de usuário*[at]*empresa*[amp]*Company.com*|
|$ (cifrão)|[cifrão]|*Usuário*  $ do *Nome* se torna *usuário*[] [dólar]*nome*|
