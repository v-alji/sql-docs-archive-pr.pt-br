 ...
 **[!INCLUDE[applies](../../includes/applies-md.md)]**  [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]Modo do SharePoint
 ...
 Os objetos de desempenho estão disponíveis no Monitor de Desempenho do Windows (**Perfmon.exe**). Para obter mais informações, consulte a documentação do Windows. [Criação de perfil de tempo de execução](https://msdn.microsoft.com/library/w4bz2147.aspx).

 **Neste tópico:**

-   [Contadores de desempenho do modo do SharePoint do serviço Web MSRS 2014](#bkmk_webservice)

-   [Contadores de desempenho do modo do SharePoint do serviço Windows MSRS 2014](#bkmk_windowsservice)

-   [Use cmdlets do PowerShell para retornar listas](#bkmk_powershell)

##  <a name="msrs-2014-web-service-sharepoint-mode-performance-counters"></a><a name="bkmk_webservice"></a>Contadores de desempenho do modo do SharePoint do serviço Web MSRS 2014
...
##  <a name="msrs-2014-windows-service-sharepoint-mode-performance-counters"></a><a name="bkmk_windowsservice"></a>Contadores de desempenho do modo SharePoint do serviço Windows MSRS 2014
...
##  <a name="use-powershell-cmdlets-to-return-lists"></a><a name="bkmk_powershell"></a>Usar cmdlets do PowerShell para retornar listas
 ![Conteúdo relacionado ao PowerShell](../media/rs-powershellicon.jpg "Conteúdo relacionado ao PowerShell")O script do Windows PowerShell a seguir retornará os conjuntos de contadores cujos CounterSetName comecem com "msr"

```powershell
Get-Counter -ListSet msr*
```

Retorna uma lista com as seguintes informações:
...
```
 ...
 O script do Windows PowerShell a seguir retornará a lista de contadores de desempenho para o CounterSetName "MSRS 2014 o modo do SharePoint do serviço Windows".
...
## <a name="see-also"></a>Consulte Também
 [Monitorando](monitoring-report-server-performance.md) [contadores de desempenho de desempenho do servidor de relatório para o serviço Web MSRS 2014 e objetos de desempenho do serviço Windows MSRS 2014 &#40;modo nativo&#41;](../report-server/performance-counters-msrs-2011-web-service-performance-objects.md)
