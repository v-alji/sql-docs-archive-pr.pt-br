...
2.  No Pesquisador de objetos, clique com o botão direito do mouse no [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] nó, aponte para **políticas**e clique em **facetas**.  
...
4.  Em **Propriedades da Faceta**:  
    ...
    -   Para ativar os eventos e a entrega agendados, defina **ScheduleEventsAndReportDeliveryEnabled** como `True` .  
  
    -   Para desativar os eventos e a entrega agendados, defina **ScheduleEventsAndReportDeliveryEnabled** como `False` .  
