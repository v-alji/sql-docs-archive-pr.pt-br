...
-   Use os dados do relatório como feeds de dados em aplicativos. Por exemplo, você pode gerar feeds de dados em conformidade com Atom que o [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] cliente pode consumir e, em seguida, trabalhar com os dados no [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] .  
