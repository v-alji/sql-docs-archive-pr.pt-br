...
-   **Expressão com execuções de texto:** Texto, **média de vendas**e expressão, e `=Avg(Fields!YTDPurchase.Value, "Sales)` texto, **número de página**e expressão`=Globals!PageNumber`  
