...
|IsHyperlink|IsVisible|KeepTogether (grupo)|Esquerda|  
...
|Temporizador|TimeSerial|TimeValue|Weekday|  
|WeekdayName|Ano|||  
...
|||||  
|-|-|-|-|  
|Méd|Contagem|Max|Mín|  
|StDev|StDevP|Somar|Var|  
|VarP||||  
...
|LCase|LCase$|Esquerda|Left$|  
|Len|LTrim|LTrim$|Mid|  
|Mid$|Substitua|Direita|Right$|  
