...
1.  Crie um novo [!INCLUDE[msCoName](../../includes/msconame-md.md)] site do ASP.NET usando o [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[csprcs](../../includes/csprcs-md.md)] ou o [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .  
...
3.  Localize o controle **ReportViewer** na **Caixa de Ferramentas** e arraste-o para a área de design abaixo do controle **ScriptManager**.  
 ...
 É possível ocultar um ou mais dos itens na barra de ferramentas ReportViewer quando o relatório é renderizado. Por exemplo, você pode ocultar o botão de impressão. Para ocultar itens da barra de ferramentas, defina as seguintes propriedades de ReportViewer como `False` no painel **Propriedades** .  
