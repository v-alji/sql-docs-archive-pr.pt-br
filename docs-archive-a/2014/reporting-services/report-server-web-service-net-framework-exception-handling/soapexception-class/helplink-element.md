 ...
 **http://** www.Microsoft.com **/** produtos **/** EE **/** Transform. aspx **? EvtSrc** = _valor_ **&EvtID**Value&valor de = _value_ ** prodname** = _value_ **&** = _valor_ ProdVer  
...
|**ProdVer**|O número da versão do [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]. Um valor de "8, 0" indica [!INCLUDE[ssVersion2000](../../../includes/ssversion2000-md.md)] [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] .|  
 ...
 O exemplo a seguir ilustra a URL **HelpLink** que é retornada para o código de erro `rsReservedItem` . Esse erro ocorre quando um usuário tenta modificar ou excluir um item reservado no [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]:  
