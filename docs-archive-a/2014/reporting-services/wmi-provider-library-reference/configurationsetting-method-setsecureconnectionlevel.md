...
-   Quando o valor é definido, o elemento SecureConnectionLevel no arquivo de configuração do servidor de relatório é alterado e o `URLRoot` elemento no arquivo de configuração é definido para usar "https://" se o *nível* especificado for maior ou igual a 1, ou "http://" se o *nível* especificado for 0.  
