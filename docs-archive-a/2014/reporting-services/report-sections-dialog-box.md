...
---
# <a name="report-sections-dialog-box"></a>Caixa de diálogo Seções do Relatório
  Quando você abre um relatório, Report Designer verifica se o relatório contém apenas um elemento RDL (Report Definition Language) **\<Section>** . Não há suporte para a abertura de um relatório com vários **\<Section>** elementos.  
