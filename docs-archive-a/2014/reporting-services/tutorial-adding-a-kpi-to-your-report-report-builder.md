...
1.  Na tabela, clique com o botão direito do mouse em duas células abaixo da `[Sum(Sales)]` célula (a linha de subtotal que exibe as vendas de uma subcategoria) e clique em **Propriedades da caixa de texto**.  
