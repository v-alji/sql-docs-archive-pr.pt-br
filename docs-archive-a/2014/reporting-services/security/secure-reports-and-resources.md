...
3.  Um invasor cria um link para a página da Web ou o servidor de relatório especificando o valor do parâmetro no formato "JavaScript: \<malicious script here> " e envia esse link para outra pessoa em um ataque de chamariz.  
