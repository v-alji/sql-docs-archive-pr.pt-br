...
1.  Abra o RSReportServer.config em um editor de texto.  
     ...
     O arquivo está localizado em * \<drive> :* \Program Files\Microsoft SQL Server\MSRS12. MSSQLSERVER\Reporting Services\ReportServer.  
