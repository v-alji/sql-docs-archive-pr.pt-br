...
|-----------------------|-----------|  
|Configurar o protocolo SSL para proteger conexões de cliente com o servidor de relatório.|[Configurar conexões SSL em um servidor de relatórios do modo nativo](configure-ssl-connections-on-a-native-mode-report-server.md)|  
