...
> [!NOTE]  
> Antes de depurar um relatório, defina um item inicial. Para definir um item de início, em Gerenciador de Soluções, clique com o botão direito do mouse no projeto de relatório, clique em **Propriedades**e, em `StartItem` , selecione o nome do relatório a ser exibido.  
