...
7.  [!INCLUDE[clickOK](../includes/clickok-md.md)]a fonte de dados [!INCLUDE[ssSampleDBnormal](../includes/sssampledbnormal-md.md)] é adicionada ao painel de **dados do relatório** .  
