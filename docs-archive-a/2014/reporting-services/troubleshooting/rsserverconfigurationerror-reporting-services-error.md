...
## <a name="user-action"></a>Ação do usuário  
 ...
 Para examinar as informações adicionais da mensagem de erro que acompanham o `rsServerConfiguration` erro, examine os arquivos de log de rastreamento do servidor de relatório, que estão localizados em \Microsoft SQL Server\MSRS12. \<instancename > \Reporting Services\LogFiles. Para obter mais informações, consulte [Fontes e arquivos de log do Reporting Services](../report-server/reporting-services-log-files-and-sources.md).  
