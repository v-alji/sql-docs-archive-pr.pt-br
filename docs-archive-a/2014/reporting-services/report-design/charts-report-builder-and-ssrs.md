...
##  <a name="designing-a-chart"></a><a name="DesigningChart"></a> Criando um gráfico  
...
##  <a name="similarities-to-a-matrix"></a><a name="SimilarMatrix"></a>Semelhanças com uma matriz  
