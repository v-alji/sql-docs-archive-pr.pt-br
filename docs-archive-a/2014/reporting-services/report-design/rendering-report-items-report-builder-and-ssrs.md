...
-   Pequenos itens de relatório, como caixas de texto ou retângulos, com uma propriedade ManterJunto explícita definida como `true` .  
...
-   Regiões de dados Tablix com uma propriedade ManterJunto explícita definida como `true` .  
