...
2.  Em **Opções de eixo**, defina `Interval` como **1**. Cada rótulo do grupo de categorias é exibido. Para mostrar cada rótulo de outro grupo de categorias no eixo x, digite **2**.  
...
2.  Em **Opções de eixo**, defina `Interval` como **automático**. O gráfico exibirá o número ideal de rótulos de categoria que podem se ajustar ao longo do eixo.  
