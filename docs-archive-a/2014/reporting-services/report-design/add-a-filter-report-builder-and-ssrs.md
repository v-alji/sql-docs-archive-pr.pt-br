...
2.  Selecione a região de dados na superfície de design e clique com o botão direito do mouse em _\<data region>_ **Propriedades**. Para um medidor, selecione **Propriedades do Painel de Medidores**. A _\<data region>_ caixa de diálogo **Propriedades** é aberta.  
