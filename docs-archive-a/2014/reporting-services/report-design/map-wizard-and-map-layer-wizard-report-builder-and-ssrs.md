...
###  <a name="what-is-an-esri-shapefile"></a><a name="Shapefile"></a>O que é um formato de forma ESRI?
 Um Arquivo de Forma ESRI é um conjunto de arquivos com dados no formato de dados espaciais de Arquivo de Forma ESRI (Environmental Systems Research Institute, Inc.). O conjunto de arquivos normalmente inclui o *\<filename>* arquivo. shp que contém os dados espaciais e um arquivo de suporte, *\<filename>* . dbf.
