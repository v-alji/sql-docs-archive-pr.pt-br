...
O [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] suplemento do (SSRS) para produtos e tecnologias do SharePoint (rsSharePoint.msi) é um download da Web que fornece recursos para integrar um servidor de relatório com uma implantação do SharePoint.  
