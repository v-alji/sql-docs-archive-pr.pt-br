...
## <a name="connection-string"></a>Cadeia de conexão  
 A cadeia de conexão é a URL para a pasta de trabalho PowerPivot publicada no SharePoint na Galeria PowerPivot ou em outra biblioteca, por exemplo, http://contoso-srv/subsite/PowerPivotLibrary/ContosoSales.xlsx .  
