...
|Cadeia de conexão|A cadeia de conexão para o banco de dados. Para obter mais informações e exibir exemplos de cadeias de conexão para fontes de dados usadas com frequência, consulte [conexões de dados, fontes de dados e cadeias de conexão no Reporting Services](../data-connections-data-sources-and-connection-strings-in-reporting-services.md).|  
...
## <a name="deleting-a-shared-data-source"></a>Excluindo uma fonte de dados compartilhada  
 Você pode excluir uma fonte de dados compartilhada da mesma forma que exclui qualquer item do servidor de relatórios. No Report Manager, abra a pasta no modo de exibição detalhes, selecione o item e clique em **excluir**. Em uma página de aplicativo em um site do SharePoint, abra a biblioteca do SharePoint, selecione o item e clique em **excluir**.  
