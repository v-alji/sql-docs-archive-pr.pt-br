...
-   Use uma \<OBJECT> marca para especificar o controle.  
...
|--------------|----------|----------|-----------------|  
|ServerPath|Em|String|Especifica o diretório virtual do servidor de relatório (por exemplo, https://adventure-works/reportserver) .|  
|ReportPathParameters|Em|String|Especifica o nome completo para o relatório no namespace da pasta do servidor de relatório, incluindo os parâmetros. Os relatórios são recuperados por meio do acesso à URL. Por exemplo:: "/AdventureWorks Sample Reports/Resumo de Vendas do Funcionário&EmpID=1234"|  
|ReportName|Em|String|O nome curto do relatório (no exemplo anterior, o nome curto é Resumo de Vendas do Funcionário). Ele será exibido na caixa de diálogo Imprimir e na fila de impressão.|  
