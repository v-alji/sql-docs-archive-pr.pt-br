...
|Tópico|Descrição|  
|-----------|-----------------|  
|[Criando o proxy de serviço Web](creating-the-web-service-proxy.md)|Descreve as maneiras de adicionar uma classe proxy ao seu projeto usando o [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] .|  
