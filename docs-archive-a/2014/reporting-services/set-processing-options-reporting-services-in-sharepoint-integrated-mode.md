...
##  <a name="to-set-data-refresh-options"></a><a name="bkmk_set_data_refresh"></a>Para definir opções de atualização de dados  
...
##  <a name="to-set-report-caching-options"></a><a name="bkmk_set_report_caching"></a>Para definir opções de cache de relatório  
...
##  <a name="to-set-processing-time-out-values"></a><a name="bkmk_set_processing"></a>Para definir valores de tempo limite de processamento  
...
##  <a name="to-set-report-history-options-and-limits"></a><a name="bkmk_set_report_history"></a>Para definir as opções e os limites do histórico de relatórios  
...
##  <a name="set-database-timeout"></a><a name="bkmk_set_database_timeout"></a>Definir tempo limite do banco de dados  
