...
## <a name="in-this-section"></a>Nesta seção  
 ...
 Fornece ajuda para caixas de diálogo usadas para gerenciar relatórios e servidores de relatório no [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] .  
