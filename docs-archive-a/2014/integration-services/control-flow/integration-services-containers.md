...
|`ID`|É o GUID do contêiner que é atribuído quando o pacote é criado. Esta propriedade é somente para leitura.<br /><br /> <xref:Microsoft.SqlServer.Dts.Runtime.DtsContainer.ID%2A>.|  
