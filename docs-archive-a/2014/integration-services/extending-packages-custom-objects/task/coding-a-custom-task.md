...
## <a name="see-also"></a>Consulte Também
 [Criando uma tarefa personalizada](creating-a-custom-task.md) que [codifica uma tarefa personalizada](coding-a-custom-task.md) que [desenvolve uma interface do usuário para uma tarefa personalizada](developing-a-user-interface-for-a-custom-task.md)
