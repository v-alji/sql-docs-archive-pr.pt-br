...
2.  Na página **script** do editor da **tarefa Script**, adicione a `CurrentImageFile` variável à `ReadOnlyVariables` propriedade.  
...
3.  Na página **script** do editor da **tarefa Script**, adicione ambas as variáveis à `ReadOnlyVariables` propriedade.  
