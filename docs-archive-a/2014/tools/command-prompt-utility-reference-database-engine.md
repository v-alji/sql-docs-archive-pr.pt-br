...
|[Aplicativo sqlagent90](sqlagent90-application.md)|Usado para iniciar o [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Agent a partir de um prompt de comando.|\<drive>:\Arquivo de Programas\Microsoft SQL Server\\<*instance_name*>\MSSQL\Binn|  
