 ...
 **/M** _machine1_ [ *machine2 * * máquinan*] |*@machinelistfile*  
 ...
 Usando *@machinelistfile* especifica um nome de arquivo de lista de máquinas a ser armazenado no arquivo de configuração.  
