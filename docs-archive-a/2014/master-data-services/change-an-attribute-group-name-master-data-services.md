...
5.  Clique no sinal de adição para expandir **grupos folha**, **grupos consolidados**ou **grupos de coleta**, dependendo do tipo de grupo que você deseja atualizar.  
  
6.  Clique no nome do grupo de atributos que você deseja alterar.  
  
7.  Clique em **editar item selecionado**.  
  
8.  Na caixa **nome do grupo de folha** , caixa **nome do grupo consolidado** ou **nome do grupo de coleta** , digite o nome atualizado do grupo de atributos.  
