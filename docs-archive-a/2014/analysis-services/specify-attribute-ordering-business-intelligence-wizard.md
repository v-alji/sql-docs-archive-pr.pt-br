 ...
 **Atributo de Ordenação**  
 ...
 Para criar um novo atributo de ordenação, selecione **\<New attribute>** e, na caixa de diálogo **selecionar uma coluna** , selecione a coluna na qual o novo atributo deve ser baseado.  
