...
##  <a name="understanding-the-structure-of-a-decision-trees-model"></a><a name="bkmk_Top"></a>Compreendendo a estrutura de um modelo de árvores de decisão  
...
##  <a name="model-content-for-a-decision-trees-model"></a><a name="bkmk_ModelContent"></a>Conteúdo do modelo para um modelo de árvores de decisão  
...
###  <a name="node-caption-and-node-description"></a><a name="NodeCaption"></a>Legenda do nó e descrição do nó  
...
###  <a name="node-score"></a><a name="NodeScore"></a>Pontuação do nó  
...
##  <a name="regression-nodes-within-a-decision-tree-model"></a><a name="bkmk_RegressionNodes"></a>Nós de regressão em um modelo de árvore de decisão  
