...
6.  Na caixa de diálogo **selecionar colunas** , examine a lista de colunas e, se necessário, altere o uso das colunas para um destes valores:  
    ...
    -   **Key**. Cada modelo requer pelo menos uma chave. Dependendo do tipo de modelo, você também pode ter a opção de chaves especiais adicionais, como **SequenceKey** ou **TimeKey**.  
