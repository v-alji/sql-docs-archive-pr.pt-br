...
||Senha|Entrada do usuário|Se estiver criando um novo farm, a frase secreta que você inserir será a frase secreta para o farm. Se você estiver adicionando o PowerPivot para SharePoint a um farm existente, você deverá fornecer a frase secreta que foi definida para o farm quando foi criado.|
