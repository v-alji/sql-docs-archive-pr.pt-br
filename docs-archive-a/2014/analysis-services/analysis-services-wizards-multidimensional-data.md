...
|[Ajuda F1 do assistente para partições &#40;Analysis Services de dados multidimensionais&#41;](partition-wizard-f1-help-analysis-services-multidimensional-data.md)|Use o Assistente para Partições para definir uma partição ou partição remota.|  
