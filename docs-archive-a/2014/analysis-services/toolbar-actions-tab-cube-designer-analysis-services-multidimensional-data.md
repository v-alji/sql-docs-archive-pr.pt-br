...
|**Excluir**|Clique para exibir a caixa de diálogo **Excluir Objetos** e excluir a ação selecionada.<br /><br /> Observação: esta opção estará habilitada apenas se o painel **Organizador de Ações** estiver selecionado.|  
