...
|**Painel Mostrar/Ocultar Diagrama**|Mostra ou oculta o **painel de diagrama**.<br /><br /> Observação: essa opção apenas será exibida se **Alternar para Construtor de Consultas VDT** estiver selecionado.|  
