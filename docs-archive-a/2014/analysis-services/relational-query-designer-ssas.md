...
#### <a name="command-type-text"></a>Tipo de comando Text  
 ...
 ![Designer de consultas genérico para a consulta de dados relacionais](media/rsqd-dsaw-sql-generic.gif "Designer de consultas genérico para a consulta de dados relacionais")  
