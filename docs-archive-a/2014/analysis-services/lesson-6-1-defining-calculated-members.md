...
12. Na barra de ferramentas da guia **cálculos** , clique em **exibição de formulário**, verifique se `[Total Sales Amount]` está selecionado no painel **organizador de script** e clique em **novo membro calculado**.  
