...
-   A propriedade [ErrorConfiguration](https://docs.microsoft.com/bi-reference/xmla/xml-elements-properties/errorconfiguration-element-xmla) especifica a maneira como o `Batch` comando manipula os erros encontrados por todos os `Process` comandos contidos no `Batch` comando.  
