...
##  <a name="modeling-measures-and-measure-groups-on-facts-and-fact-tables"></a><a name="bkmk_modeling"></a>Medidas de modelagem e grupos de medidas em fatos e tabelas de fatos
 ...
 ![Tabela FactSalesQuota com duas tabelas de dimensão](../media/factsalesquota.gif "Tabela FactSalesQuota com duas tabelas de dimensão")
...
## <a name="see-also"></a>Consulte Também
 [Cubos em modelos multidimensionais](cubes-in-multidimensional-models.md) [medidas e grupos de medidas](measures-and-measure-groups.md)
