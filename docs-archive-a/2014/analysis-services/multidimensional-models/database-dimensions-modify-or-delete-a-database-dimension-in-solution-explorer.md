...
2.  Na guia **Estrutura da Dimensão** , nos painéis **Atributos**, **Hierarquias**ou **Exibição da Fonte de Dados** , clique no item que você quer modificar e, em seguida, faça as alterações.  
     ...
     Para obter mais informações sobre os tipos de alterações que você pode fazer, consulte [processamento de objeto de modelo multidimensional](processing-a-multidimensional-model-analysis-services.md).  
