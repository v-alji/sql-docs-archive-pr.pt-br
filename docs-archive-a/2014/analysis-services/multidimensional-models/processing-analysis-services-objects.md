...
##  <a name="processing-a-database"></a><a name="bkmk_procdb"></a>Processando um banco de dados  
...
##  <a name="processing-a-cube"></a><a name="bkmk_proccube"></a>Processando um cubo  
...
##  <a name="processing-a-dimension"></a><a name="bkmk_procdim"></a>Processando uma dimensão  
...
##  <a name="processing-a-measure-group"></a><a name="bkmk_procmeasure"></a>Processando um grupo de medidas  
...
##  <a name="processing-a-partition"></a><a name="bkmk_procpartition"></a>Processando uma partição  
...
##  <a name="processing-data-mining-structures-and-models"></a><a name="bkmk_procdm"></a>Processando estruturas e modelos de mineração de dados  
