...
##  <a name="usage-data-collection-and-reporting-architecture"></a><a name="usagearch"></a> Coleta de dados de uso e arquitetura de relatórios  
...
##  <a name="sources-of-usage-data"></a><a name="sources"></a> Fontes de dados de uso  
...
##  <a name="reporting-on-usage-data"></a><a name="reporting"></a> Relatórios sobre dados de uso  
