...
##  <a name="view-data-refresh-history-for-an-individual-workbook"></a><a name="viewhistory"></a>Exibir o histórico de atualização de dados de uma pasta de trabalho individual  
...
##  <a name="view-data-refresh-history-for-all-workbooks"></a><a name="viewITOps"></a>Exibir o histórico de atualização de dados para todas as pastas de trabalho  
...
##  <a name="use-history-information"></a><a name="pageelements"></a>Usar informações de histórico  
