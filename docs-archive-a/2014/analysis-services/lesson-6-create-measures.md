...
1.  Usando o recurso AutoSoma, crie e nomeie as seguintes medidas:  
    ...
    |Nome da Medida|Column|AutoSoma (∑)|Fórmula|  
    |------------------|------------|-------------------|-------------|  
    ...
    |Unidades Totais da Internet|Order Quantity|Somar|=SUM([Quantidade do Pedido])|  
    |Valor do Desconto Total pela Internet|Valor do desconto|Somar|=SUM([Valor do Desconto])|  
    |Custo Total do Produto da Internet|Custo Total do Produto|Somar|=SUM([Custo Total do Produto])|  
    |Vendas Totais pela Internet|Valor das Vendas|Somar|=SUM([Valor das Vendas])|  
    |Margem Total da Internet|Margem|Somar|=SUM([Margem])|  
    |Valor Total dos Imp. da Internet|Valor dos Impostos|Somar|=SUM([Valor dos Imp.])|  
    |Frete Total da Internet|Freight|Somar|=SUM([Freight])|  
