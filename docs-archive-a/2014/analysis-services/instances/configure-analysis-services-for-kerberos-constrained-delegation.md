...
##  <a name="allow-analysis-services-to-impersonate-a-user-identity"></a><a name="bkmk_impersonate"></a>Permitir que Analysis Services represente uma identidade de usuário  
...
##  <a name="configure-analysis-services-for-trusted-delegation"></a><a name="bkmk_delegate"></a>Configurar Analysis Services para delegação confiável  
...
##  <a name="test-for-impersonated-or-delegated-identity"></a><a name="bkmk_test"></a>Testar a identidade representada ou delegada  
