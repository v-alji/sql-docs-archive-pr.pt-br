...
##  <a name="background"></a><a name="bkmk_background"></a> Plano de fundo  
...
##  <a name="step-2-configure-basic-analysis-services-sharepoint-integration"></a><a name="bkmk_config"></a>Etapa 2: configurar a integração básica do Analysis Services SharePoint  
...
##  <a name="step-3-verify-the-integration"></a><a name="bkmk_verify"></a>Etapa 3: verificar a integração  
...
##  <a name="configure-the-windows-firewall-to-allow-analysis-services-access"></a><a name="bkmk_firewall"></a>Configurar o Firewall do Windows para permitir acesso Analysis Services  
...
##  <a name="upgrade-workbooks-and-scheduled-data-refresh"></a><a name="bkmk_upgrade_workbook"></a>Atualizar pastas de trabalho e atualização de dados agendada  
...
##  <a name="beyond-the-single-server-installation--powerpivot-for-microsoft-sharepoint"></a><a name="bkmk_multiple_servers"></a>Além da instalação de servidor único – PowerPivot para Microsoft SharePoint  
