...
##  <a name="connect-using-sql-server-management-studio-ssms"></a><a name="bkmk_SSMS"></a> Conectar usando o SQL Server Management Studio (SSMS)  
...
##  <a name="connect-using-excel"></a><a name="bkmk_excel"></a>Conectar-se usando o Excel  
...
##  <a name="connect-using-sql-server-data-tools"></a><a name="bkmk_SSDT"></a>Conectar usando SQL Server Data Tools  
...
##  <a name="test-connections"></a><a name="bkmk_tshoot"></a>Testar conexões  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Metodologias de autenticação com suporte pelo Analysis Services](authentication-methodologies-supported-by-analysis-services.md)   
