 ...
 **Exemplo de sintaxe para uma instância nomeada em execução como NT Service\MSOLAP$\<instance-name>**  
...
## <a name="see-also"></a>Consulte Também  
 ...
 [Sintaxe de SetSPN (nomes da entidade de serviço) (Setspn.exe)](https://social.technet.microsoft.com/wiki/contents/articles/717.service-principal-names-spns-setspn-syntax-setspn-exe.aspx)   
