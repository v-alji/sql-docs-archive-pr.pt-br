...
### <a name="obtaining-documentation-for-ssnoversion"></a>Obtendo a documentação para o [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
 A documentação para o [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] está disponível online. Para obter mais informações, consulte [usar a documentação do produto para SQL Server](../index.yml).  
...
## <a name="see-also"></a>Consulte Também  
 [Introdução à documentação do produto para SQL Server](../index.yml)   
