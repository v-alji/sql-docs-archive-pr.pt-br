...
|route|Um objeto do Service Broker que especifica o endereço de rede para um serviço remoto.|  
...
|coerência forte|Cenário em que a alta disponibilidade é habilitada e é mais que uma cópia de um objeto armazenado em cache no cluster de cache. Todas as cópias desse objeto permanecem idênticas.|  
