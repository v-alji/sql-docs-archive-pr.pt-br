...
-   [Permitir o acesso à rede para um ponto de extremidade de espelhamento de banco de dados usando a autenticação do Windows &#40;SQL Server&#41;](../database-mirroring-allow-network-access-windows-authentication.md).  
