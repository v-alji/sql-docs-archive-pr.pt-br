...
##  <a name="availability-group-listeners"></a><a name="AGlisteners"></a>Ouvintes do grupo de disponibilidade  
...
###  <a name="availability-group-listener-configuration"></a><a name="AGlConfig"></a> Configuração de ouvinte de grupo de disponibilidade  
...
###  <a name="selecting-an-availability-group-listener-port"></a><a name="SelectListenerPort"></a> Selecionando uma porta de ouvinte de grupo de disponibilidade  
...
##  <a name="using-a-listener-to-connect-to-the-primary-replica"></a><a name="ConnectToPrimary"></a>Usando um ouvinte para se conectar à réplica primária  
...
##  <a name="using-a-listener-to-connect-to-a-read-only-secondary-replica-read-only-routing"></a><a name="ConnectToSecondary"></a> Usando um ouvinte para conectar a uma réplica secundária somente leitura (roteamento somente leitura)  
...
###  <a name="to-configure-availability-replicas-for-read-only-routing"></a><a name="ConfigureARsForROR"></a> Para configurar réplicas de disponibilidade para roteamento somente leitura  
...
####  <a name="related-tasks"></a><a name="RelatedTasksROR"></a> Tarefas relacionadas  
...
###  <a name="read-only-application-intent-and-read-only-routing"></a><a name="ReadOnlyAppIntent"></a>Tentativa de aplicativo somente leitura e roteamento somente leitura  
...
####  <a name="related-tasks"></a><a name="RelatedTasksApps"></a> Tarefas relacionadas  
...
##  <a name="bypassing-availability-group-listeners"></a><a name="BypassAGl"></a>Ignorando ouvintes do grupo de disponibilidade  
...
###  <a name="using-database-mirroring-connection-strings-with-availability-groups"></a><a name="DbmConnectionString"></a>Usando cadeias de conexão de espelhamento de banco de dados com grupos de disponibilidade  
...
##  <a name="behavior-of-client-connections-on-failover"></a><a name="CCBehaviorOnFailover"></a>Comportamento de conexões de cliente no failover  
...
##  <a name="supporting-availability-group-multi-subnet-failovers"></a><a name="SupportAgMultiSubnetFailover"></a> Dando suporte a failovers de várias sub-redes de grupo de disponibilidade  
...
##  <a name="availability-group-listeners-and-ssl-certificates"></a><a name="SSLcertificates"></a> Ouvintes de grupo de disponibilidade e certificados SSL  
...
##  <a name="availability-group-listeners-and-server-principal-names-spns"></a><a name="SPNs"></a>Ouvintes de grupo de disponibilidade e SPNs (nomes de entidade de servidor)  
