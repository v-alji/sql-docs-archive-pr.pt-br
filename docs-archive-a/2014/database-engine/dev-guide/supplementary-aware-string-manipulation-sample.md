...
```  
 ...
 Este é o script de instalação do [!INCLUDE[tsql](../../includes/tsql-md.md)] (`Install.sql`) que implanta o assembly e cria as funções de reconhecimento de suplementar no banco de dados.  
