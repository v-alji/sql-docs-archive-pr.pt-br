...
ms.locfileid: "87571548"
---
# <a name="calendar-aware-date-and-time-udt-sample"></a><span data-ttu-id="4a910-102">Exemplo de UDT de data e hora com reconhecimento de calendário</span><span class="sxs-lookup"><span data-stu-id="4a910-102">Calendar-Aware Date and Time UDT Sample</span></span>
  <span data-ttu-id="4a910-103">Armazenar datas como cadeias de caracteres pode ser confuso, pois as datas não fazem sentido quando não se entende qual sistema de calendário está sendo usado. O exemplo `CADatetime` define dois tipos de dados definidos pelo usuário, `CADatetime` e `CADate`, que fornecem manipulação de datas e horas com base no calendário.</span><span class="sxs-lookup"><span data-stu-id="4a910-103">Storing dates as strings can be confusing because dates are meaningless without understanding what calendar system is being used.The `CADatetime` sample defines two user-defined data types, `CADatetime` and `CADate`, which provide calendar-aware handling of dates and times.</span></span>  
  
## <a name="prerequisites"></a><span data-ttu-id="4a910-104">Pré-requisitos</span><span class="sxs-lookup"><span data-stu-id="4a910-104">Prerequisites</span></span>  
 <span data-ttu-id="4a910-105">Para criar e executar este projeto, o software a seguir deve estar instalado:</span><span class="sxs-lookup"><span data-stu-id="4a910-105">To create and run this project the following the following software must be installed:</span></span>  
  
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] <span data-ttu-id="4a910-106">ou [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express.</span><span class="sxs-lookup"><span data-stu-id="4a910-106">or [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express.</span></span> <span data-ttu-id="4a910-107">É possível obter o [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express gratuitamente no [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] site [de Documentação e Amostras do](https://www.microsoft.com/sql-server/sql-server-editions-express)Express</span><span class="sxs-lookup"><span data-stu-id="4a910-107">You can obtain [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express free of charge from the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express Documentation and Samples [Web site](https://www.microsoft.com/sql-server/sql-server-editions-express)</span></span>  
  
-   <span data-ttu-id="4a910-108">O banco de dados AdventureWorks que está disponível no [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] site [do](https://go.microsoft.com/fwlink/?linkid=62796)Developer</span><span class="sxs-lookup"><span data-stu-id="4a910-108">The AdventureWorks database that is available at the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Developer [Web site](https://go.microsoft.com/fwlink/?linkid=62796)</span></span>  
  
-   <span data-ttu-id="4a910-109">.NET Framework SDK 2.0 ou posterior ou Microsoft Visual Studio 2005 ou posterior.</span><span class="sxs-lookup"><span data-stu-id="4a910-109">.NET Framework SDK 2.0 or later or Microsoft Visual Studio 2005 or later.</span></span> <span data-ttu-id="4a910-110">Você pode obter o .NET Framework SDK gratuitamente.</span><span class="sxs-lookup"><span data-stu-id="4a910-110">You can obtain .NET Framework SDK free of charge.</span></span>  
  
-   <span data-ttu-id="4a910-111">Além disso, as seguintes condições devem ser atendidas:</span><span class="sxs-lookup"><span data-stu-id="4a910-111">In addition, the following conditions must be met:</span></span>  
  
-   <span data-ttu-id="4a910-112">A instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que você está usando deve ter a integração CLR habilitada.</span><span class="sxs-lookup"><span data-stu-id="4a910-112">The [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance you are using must have CLR integration enabled.</span></span>  
  
-   <span data-ttu-id="4a910-113">Para habilitar a integração CLR, execute as etapas a seguir:</span><span class="sxs-lookup"><span data-stu-id="4a910-113">In order to enable CLR integration, perform the following steps:</span></span>  
  
    #### <a name="enabling-clr-integration"></a><span data-ttu-id="4a910-114">Habilitando integração CLR</span><span class="sxs-lookup"><span data-stu-id="4a910-114">Enabling CLR Integration</span></span>  
  
    -   <span data-ttu-id="4a910-115">Execute os seguintes comandos [!INCLUDE[tsql](../../includes/tsql-md.md)] :</span><span class="sxs-lookup"><span data-stu-id="4a910-115">Execute the following [!INCLUDE[tsql](../../includes/tsql-md.md)] commands:</span></span>  
    ...
    > [!NOTE]  
    >  <span data-ttu-id="4a910-116">Para habilitar o CLR, é necessário ter a permissão `ALTER SETTINGS` de nível de servidor, que é mantida implicitamente por membros das funções de servidor fixas `sysadmin` e `serveradmin`.</span><span class="sxs-lookup"><span data-stu-id="4a910-116">To enable CLR, you must have `ALTER SETTINGS` server level permission, which is implicitly held by members of the `sysadmin` and `serveradmin` fixed server roles.</span></span>  
  
-   <span data-ttu-id="4a910-117">O banco de dados AdventureWorks deve estar instalado na instância do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que você está usando.</span><span class="sxs-lookup"><span data-stu-id="4a910-117">The AdventureWorks database must be installed on the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance you are using.</span></span>  
  
-   <span data-ttu-id="4a910-118">Se você não for um administrador da [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instância que está usando, deverá ter um administrador para conceder a permissão **CreateAssembly** para concluir a instalação.</span><span class="sxs-lookup"><span data-stu-id="4a910-118">If you are not an administrator for the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance you are using, you must have an administrator grant you **CreateAssembly**  permission to complete the installation.</span></span>  
  
## <a name="building-the-sample"></a><span data-ttu-id="4a910-119">Compilando o exemplo</span><span class="sxs-lookup"><span data-stu-id="4a910-119">Building the Sample</span></span>  
  
#### <a name="create-and-run-the-sample-by-using-the-following-instructions"></a><span data-ttu-id="4a910-120">Crie e execute o exemplo seguindo estas instruções:</span><span class="sxs-lookup"><span data-stu-id="4a910-120">Create and run the sample by using the following instructions:</span></span>  
  
1.  <span data-ttu-id="4a910-121">Abra um prompt de comando do Visual Studio ou do .NET Framework.</span><span class="sxs-lookup"><span data-stu-id="4a910-121">Open a Visual Studio or .NET Framework command prompt.</span></span>  
  
2.  <span data-ttu-id="4a910-122">Se necessário, crie um diretório para o seu exemplo.</span><span class="sxs-lookup"><span data-stu-id="4a910-122">If necessary, create a directory for your sample.</span></span> <span data-ttu-id="4a910-123">Para este exemplo, usaremos C:\MySample.</span><span class="sxs-lookup"><span data-stu-id="4a910-123">For this example, we will use C:\MySample.</span></span>  
  
3.  <span data-ttu-id="4a910-124">Em c:\MySample, crie o arquivo `CalendarAware.cs` e copie o código de exemplo C# (abaixo) nele.</span><span class="sxs-lookup"><span data-stu-id="4a910-124">In c:\MySample, create `CalendarAware.cs` and copy the C# sample code (below) into the file.</span></span>  
  
4.  <span data-ttu-id="4a910-125">Em c:\MySample, crie o arquivo `calendars.txt` e copie o código de exemplo no arquivo.</span><span class="sxs-lookup"><span data-stu-id="4a910-125">In c:\MySample, create the file `calendars.txt` and copy the sample code into the file.</span></span>  
  
5.  <span data-ttu-id="4a910-126">Em c:\MySample, crie o arquivo `calendars.ar-SA.txt` e copie o seguinte nele:</span><span class="sxs-lookup"><span data-stu-id="4a910-126">In c:\MySample, create the file `calendars.ar-SA.txt` and copy the following into the file:</span></span>  
  
    -   `; the default calendar for this culture`  
  
    -   `DefaultCalendarID = 1`  
  
6.  <span data-ttu-id="4a910-127">Em c:\MySample, crie o arquivo `calendars.ja.txt` e copie o seguinte nele:</span><span class="sxs-lookup"><span data-stu-id="4a910-127">In c:\MySample, create the file `calendars.ja.txt` and copy the following into the file:</span></span>  
  
    -   `; the default calendar for this culture`  
  
    -   `DefaultCalendarID = 3`  
  
7.  <span data-ttu-id="4a910-128">Em c:\MySample, crie o arquivo `calendars.``zh-CN.txt` e copie o seguinte nele:</span><span class="sxs-lookup"><span data-stu-id="4a910-128">In c:\MySample, create the file `calendars.``zh-CN.txt` and copy the following into the file:</span></span>  
  
    -   `; the default calendar for this culture`  
  
    -   `DefaultCalendarID = 8`  
  
8.  <span data-ttu-id="4a910-129">Em c:\MySample, crie o arquivo `build.com` e copie o seguinte nele:</span><span class="sxs-lookup"><span data-stu-id="4a910-129">In c:\MySample, create the file `build.com` and copy the following into the file:</span></span>  
...
9. <span data-ttu-id="4a910-130">Compile os assemblies satélites executando a compilação de arquivo no prompt de comando.</span><span class="sxs-lookup"><span data-stu-id="4a910-130">Build the satellite assembles by executing the file build at the command prompt.</span></span>  
  
10. <span data-ttu-id="4a910-131">Compile o código de exemplo a partir do prompt de linha de comando executando o seguinte:</span><span class="sxs-lookup"><span data-stu-id="4a910-131">Compile the sample code from the command line prompt by executing the following:</span></span>  
...
11. <span data-ttu-id="4a910-132">Copie o código de instalação [!INCLUDE[tsql](../../includes/tsql-md.md)] em um arquivo e salve-o como `Install.sql` no diretório de exemplo.</span><span class="sxs-lookup"><span data-stu-id="4a910-132">Copy the [!INCLUDE[tsql](../../includes/tsql-md.md)] installation code into a file and save it as `Install.sql` in the sample directory.</span></span>  
  
12. <span data-ttu-id="4a910-133">Se o exemplo tiver sido instalado em um diretório diferente de `C:\MySample\`, edite o arquivo `Install.sql` conforme indicado para apontar para esse local.</span><span class="sxs-lookup"><span data-stu-id="4a910-133">If the sample is installed in a directory other then `C:\MySample\`, edit the file `Install.sql` as indicated to point to that location.</span></span>  
  
13. <span data-ttu-id="4a910-134">Implante o assembly e o procedimento armazenado executando o seguinte</span><span class="sxs-lookup"><span data-stu-id="4a910-134">Deploy the assembly and stored procedure by executing</span></span>  
  
    -   `sqlcmd -E -I -i install.sql`  
  
14. <span data-ttu-id="4a910-135">Copie o script de comando de teste do [!INCLUDE[tsql](../../includes/tsql-md.md)] em um arquivo e salve-o como `test.sql` no diretório de exemplo.</span><span class="sxs-lookup"><span data-stu-id="4a910-135">Copy [!INCLUDE[tsql](../../includes/tsql-md.md)] test command script into a file and save it as `test.sql` in the sample directory.</span></span>  
  
15. <span data-ttu-id="4a910-136">Execute o script de teste com o seguinte comando</span><span class="sxs-lookup"><span data-stu-id="4a910-136">Execute the test script with the following command</span></span>  
  
    -   `sqlcmd -E -I -i test.sql`  
  
16. <span data-ttu-id="4a910-137">Copie o script de limpeza [!INCLUDE[tsql](../../includes/tsql-md.md)] em um arquivo e salve-o como `cleanup.sql` no diretório de exemplo.</span><span class="sxs-lookup"><span data-stu-id="4a910-137">Copy the [!INCLUDE[tsql](../../includes/tsql-md.md)] cleanup script into a file and save it as `cleanup.sql` in the sample directory.</span></span>  
  
17. <span data-ttu-id="4a910-138">Execute o script com o seguinte comando</span><span class="sxs-lookup"><span data-stu-id="4a910-138">Execute the script with the  following command</span></span>  
  
    -   `sqlcmd -E -I -i cleanup.sql`  
  
## <a name="sample-code"></a><span data-ttu-id="4a910-139">Exemplo de código</span><span class="sxs-lookup"><span data-stu-id="4a910-139">Sample Code</span></span>  
 <span data-ttu-id="4a910-140">As listagens de código deste exemplo são as seguintes.</span><span class="sxs-lookup"><span data-stu-id="4a910-140">The following are the code listings for this sample.</span></span>  
  
 <span data-ttu-id="4a910-141">C#</span><span class="sxs-lookup"><span data-stu-id="4a910-141">C#</span></span>  
...
```  
 ...
 <span data-ttu-id="4a910-142">Este é o arquivo `calendars.txt` necessário para definir os calendários.</span><span class="sxs-lookup"><span data-stu-id="4a910-142">This is the file `calendars.txt` needed for defining the calendars.</span></span>  
...
```  
 ...
 <span data-ttu-id="4a910-143">Este é o script de instalação [!INCLUDE[tsql](../../includes/tsql-md.md)] (`Install.sql`), que implanta os assembly e cria as funções de conversão dentro do banco de dados; ele também cria uma tabela de dados de exemplo.</span><span class="sxs-lookup"><span data-stu-id="4a910-143">This is the [!INCLUDE[tsql](../../includes/tsql-md.md)] installation script (`Install.sql`), which deploys the assemblies and creates the conversion functions within the database; it also crates a table of sample data.</span></span>  
...
```  
 ...
 <span data-ttu-id="4a910-144">Este é `test.sql`, que testa o exemplo executando as funções em vários calendários.</span><span class="sxs-lookup"><span data-stu-id="4a910-144">This is `test.sql`, which tests the sample by executing the functions on various calendars.</span></span>  
...
```  
 ...
 <span data-ttu-id="4a910-145">O [!INCLUDE[tsql](../../includes/tsql-md.md)] a seguir remove os assemblies, as funções e a tabela do banco de dados.</span><span class="sxs-lookup"><span data-stu-id="4a910-145">The following [!INCLUDE[tsql](../../includes/tsql-md.md)] removes the assemblies, functions and table from the database.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="4a910-146">Consulte Também</span><span class="sxs-lookup"><span data-stu-id="4a910-146">See Also</span></span>  
 [<span data-ttu-id="4a910-147">Cenários de uso e exemplos para a integração do CLR &#40;Common Language Runtime&#41;</span><span class="sxs-lookup"><span data-stu-id="4a910-147">Usage Scenarios and Examples for Common Language Runtime &#40;CLR&#41; Integration</span></span>](../../../2014/database-engine/dev-guide/usage-scenarios-and-examples-for-common-language-runtime-clr-integration.md)  
