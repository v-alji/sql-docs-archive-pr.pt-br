...
3.  Em c:\MySample, crie `ComplexNumber.vb` (para o exemplo do Visual Basic) ou `ComplexNumber.cs` (para o exemplo do C#) e copie o código de exemplo adequado do Visual Basic ou do C# (a seguir) no arquivo.  
...
6.  Copie o código de instalação [!INCLUDE[tsql](../../includes/tsql-md.md)] em um arquivo e salve-o como `Install.sql` no diretório de exemplo.  
  
7.  Se o exemplo tiver sido instalado em um diretório diferente de `C:\MySample\`, edite o arquivo `Install.sql` conforme indicado para apontar para esse local.  
  
8.  Implante o assembly e o procedimento armazenado executando o seguinte  
...
11. Para executar o programa de exemplo de cliente (apenas C#):  
  
    -   Em c:\MySample, crie `Program.cs` e copie o código-fonte no arquivo.  
  
    -   Executados`: Csc /reference:ComplexNumber.dll /reference:C:\Windows\Microsoft.NET\Framework\v2.0.50727\System.Data.dll /reference:C:\Windows\Microsoft.NET\Framework\v2.0.50727\System.dll /reference:C:\Windows\Microsoft.NET\Framework\v2.0.50727\System.XML.dll /out:Client.exe /target:exe Program.cs`  
  
    -   Teste executando: `Client AdventureWorks`  
