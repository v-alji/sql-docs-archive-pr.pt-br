...
-   Marca de seleção verde – ![](../../2014/database-engine/media/well-utilized.gif "Well_utilized"): número de instâncias gerenciadas do [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] que não estão violando as políticas de utilização de recursos. Os recursos estão bem-utilizados.  
