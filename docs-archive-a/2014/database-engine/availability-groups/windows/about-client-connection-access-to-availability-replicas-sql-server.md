...
|------------------|--------------------------------------------|-----------------------|--------------------------------|  
|Secundário|Tudo|Intenção de leitura, leitura/gravação ou nenhuma intenção de conexão especificada|Sucesso|  
...
|Replica2|Síncrono|Secundário|Nenhum|Leitura-gravação|  
|Replica3|Assíncrona|Secundário|Somente tentativa de leitura|Leitura-gravação|  
|Replica4|Assíncronos|Secundário|Tentativa de leitura somente|Leitura-gravação|  
