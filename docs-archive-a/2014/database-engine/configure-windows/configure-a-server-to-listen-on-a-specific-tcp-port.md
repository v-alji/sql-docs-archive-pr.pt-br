...
4.  Na área da caixa **Propriedades** de **IP**_n_, na caixa **Porta TCP**, digite o número da porta em que esse endereço IP deverá escutar e, em seguida, clique em **OK**.  
