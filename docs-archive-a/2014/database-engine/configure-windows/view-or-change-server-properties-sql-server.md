...
4.  No **SQL Server (\<***instancename***>) na caixa de diálogo Propriedades**, altere as propriedades do servidor na guia **Serviço** ou na guia **Avançado** e clique em **OK**.  
  
##  <a name="follow-up-after-you-change-server-properties"></a><a name="FollowUp"></a>Acompanhamento: depois de alterar as propriedades do servidor  
