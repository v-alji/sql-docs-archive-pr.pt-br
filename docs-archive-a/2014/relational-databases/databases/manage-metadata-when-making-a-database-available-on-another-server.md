...
##  <a name="cross-database-queries"></a><a name="cross_database_queries"></a>Consultas entre bancos de dados  
...
##  <a name="database-ownership"></a><a name="database_ownership"></a>Propriedade do banco de dados  
...
##  <a name="encrypted-data"></a><a name="encrypted_data"></a>Dados criptografados  
...
##  <a name="event-notifications-and-windows-management-instrumentation-wmi-events-at-server-level"></a><a name="event_notif_and_wmi_events"></a>Notificações de eventos e eventos de Instrumentação de Gerenciamento do Windows (WMI) (em nível de servidor)  
...
##  <a name="extended-stored-procedures"></a><a name="extended_stored_procedures"></a>Procedimentos armazenados estendidos  
...
##  <a name="full-text-engine-for-sql-server-properties"></a><a name="ifts_service_properties"></a>Mecanismo de texto completo para propriedades de SQL Server  
...
##  <a name="jobs"></a><a name="jobs"></a>Sejam  
...
##  <a name="replication-settings"></a><a name="replication_settings"></a>Configurações de replicação  
...
##  <a name="service-broker-applications"></a><a name="sb_applications"></a>Service Broker aplicativos  
...
##  <a name="startup-procedures"></a><a name="startup_procedures"></a>Procedimentos de inicialização  
...
##  <a name="triggers-at-server-level"></a><a name="triggers"></a>Gatilhos (em nível de servidor)  
