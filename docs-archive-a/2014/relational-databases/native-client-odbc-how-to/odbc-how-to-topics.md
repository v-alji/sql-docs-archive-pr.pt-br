...
-   [Alocar identificadores e conectar-se ao SQL Server &#40;ODBC&#41;](allocate-handles-and-connect-to-sql-server-odbc.md)  
  
-   [Tópicos de instruções sobre como executar consultas &#40;ODBC&#41;](execute-queries/executing-queries-how-to-topics-odbc.md)  
...
-   [Tópicos de instruções sobre o uso de cursores &#40;ODBC&#41;](cursors/using-cursors-how-to-topics-odbc.md)  
  
-   [Usar o Microsoft Coordenador de Transações Distribuídas &#40;ODBC&#41;](use-microsoft-distributed-transaction-coordinator-odbc.md)  
...
-   [Tópicos de instruções sobre cópia em massa com o SQL Server ODBC Driver &#40;ODBC&#41;](bulk-copy/bulk-copying-with-the-sql-server-odbc-driver-how-to-topics-odbc.md)  
