...
ms.locfileid: "87569424"
---
# <a name="use-table-valued-parameters-odbc"></a><span data-ttu-id="023a5-102">Usar Parâmetros com valor de tabela (ODBC)</span><span class="sxs-lookup"><span data-stu-id="023a5-102">Use Table-Valued Parameters (ODBC)</span></span>
  <span data-ttu-id="023a5-103">Este exemplo mostra como usar parâmetros com valor de tabela para inserir várias linhas, com várias colunas, com uma chamada para o servidor.</span><span class="sxs-lookup"><span data-stu-id="023a5-103">This sample shows how to use table-valued parameters to insert multiple rows, with multiple columns, with one call to the server.</span></span>  
  
 <span data-ttu-id="023a5-104">Para obter mais informações sobre parâmetros com valor de tabela, consulte [parâmetros com valor de tabela &#40;&#41;ODBC ](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span><span class="sxs-lookup"><span data-stu-id="023a5-104">For more information about table-valued parameters, see [Table-Valued Parameters &#40;ODBC&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span></span> <span data-ttu-id="023a5-105">Para obter mais exemplos que usem parâmetros com valor de tabela, consulte [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span><span class="sxs-lookup"><span data-stu-id="023a5-105">For more samples using table-valued parameters, see [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="023a5-106">Exemplo</span><span class="sxs-lookup"><span data-stu-id="023a5-106">Example</span></span>  
 <span data-ttu-id="023a5-107">Você precisará de uma fonte de dados ODBC chamada TVPDemo.</span><span class="sxs-lookup"><span data-stu-id="023a5-107">You will need an ODBC data source called TVPDemo.</span></span> <span data-ttu-id="023a5-108">O banco de dados padrão para TVPDemo pode ser qualquer banco de dados de teste em seu computador.</span><span class="sxs-lookup"><span data-stu-id="023a5-108">The default database for TVPDemo can be any test database on your computer.</span></span> <span data-ttu-id="023a5-109">Essa fonte de dados deve ter como base o driver ODBC do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span><span class="sxs-lookup"><span data-stu-id="023a5-109">This data source must be based on the ODBC driver for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span></span>  
  
 <span data-ttu-id="023a5-110">Se você compilar e executar esse exemplo como um aplicativo de 32 bits em um sistema operacional de 64 bits, deverá criar a fonte de dados ODBC com o Administrador ODBC em %windir%\SysWOW64\odbcad32.exe.</span><span class="sxs-lookup"><span data-stu-id="023a5-110">If you will build and run this sample as a 32-bit application on a 64-bit operating system, you must create the ODBC data source with the ODBC Administrator in %windir%\SysWOW64\odbcad32.exe.</span></span>  
  
 <span data-ttu-id="023a5-111">Esse aplicativo se conecta à instância padrão do [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] do computador.</span><span class="sxs-lookup"><span data-stu-id="023a5-111">This sample connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="023a5-112">Para conectar-se a uma instância nomeada, altere a definição da fonte de dados ODBC para especificar a instância usando o seguinte formato: servidor\instância_nomeada.</span><span class="sxs-lookup"><span data-stu-id="023a5-112">To connect to a named instance, change the definition of the ODBC data source to specify the instance using the following format: server\namedinstance.</span></span> <span data-ttu-id="023a5-113">Por padrão, o [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] é instalado em uma instância nomeada.</span><span class="sxs-lookup"><span data-stu-id="023a5-113">By default, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] installs to a named instance.</span></span>  
  
 <span data-ttu-id="023a5-114">Compile a listagem de código (C++) com odbc32.lib e user32.lib.</span><span class="sxs-lookup"><span data-stu-id="023a5-114">Compile the (C++) code listing with odbc32.lib and user32.lib.</span></span> <span data-ttu-id="023a5-115">Verifique se a variável de ambiente INCLUDE inclui o diretório que contém sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="023a5-115">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
