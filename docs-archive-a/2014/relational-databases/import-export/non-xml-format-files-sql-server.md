...
-   Você pode criar um arquivo de formato para um tipo de dados específico, como dados de caractere ou dados nativos.  
     ...
     Você pode criar um arquivo de formato não XML que contém atributos especificados interativamente para cada campo de dados. Para obter mais informações, veja [Especificar formatos de dados para compatibilidade usando bcp &#40;SQL Server&#41;](specify-data-formats-for-compatibility-when-using-bcp-sql-server.md).  
...
##  <a name="structure-of-non-xml-format-files"></a><a name="Structure"></a> Estrutura de arquivos de formato não XML  
 ...
 ![Identifica os campos de um arquivo de formato não XML](../../database-engine/media/mydepart-fmt-ident-c.gif "Identifica os campos de um arquivo de formato não XML")  
