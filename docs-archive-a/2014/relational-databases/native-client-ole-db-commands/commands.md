...
# <a name="commands"></a>Comandos
  O [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] provedor de OLE DB de cliente nativo expõe a interface **ICommand** e os objetos de comando, que são descritos nesta seção:  
