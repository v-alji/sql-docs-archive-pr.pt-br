...
ms.locfileid: "87685604"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="28580-102">Suporte de transmissão a parâmetros de saída BLOB</span><span class="sxs-lookup"><span data-stu-id="28580-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="28580-103">Este tópico contém um exemplo que mostra o suporte de transmissão a parâmetros de saída BLOB, que associa parâmetros de saída BLOB como ISequentialStreams.</span><span class="sxs-lookup"><span data-stu-id="28580-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="28580-104">Você pode ser bloqueado em parâmetros de saída em IMultipleResults::GetResult, recebendo o valor de retorno DB_E_OBJECTOPEN.</span><span class="sxs-lookup"><span data-stu-id="28580-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="28580-105">O chamador deve verificar se há parâmetros BLOB pendentes e lê-los completamente ou liberá-los.</span><span class="sxs-lookup"><span data-stu-id="28580-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="28580-106">Exemplo</span><span class="sxs-lookup"><span data-stu-id="28580-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="28580-107">Código</span><span class="sxs-lookup"><span data-stu-id="28580-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="28580-108">Consulte Também</span><span class="sxs-lookup"><span data-stu-id="28580-108">See Also</span></span>  
 [<span data-ttu-id="28580-109">BLOBs e objetos OLE</span><span class="sxs-lookup"><span data-stu-id="28580-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
