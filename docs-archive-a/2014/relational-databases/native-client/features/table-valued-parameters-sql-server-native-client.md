...
# <a name="table-valued-parameters-sql-server-native-client"></a>Parâmetros com valor de tabela (SQL Server Native Client)
 ...
 Para obter informações sobre parâmetros com valor de tabela e OLE DB, confira [Parâmetros com valor de tabela &#40;OLE DB&#41;](../../native-client-ole-db-table-valued-parameters/table-valued-parameters-ole-db.md).  
