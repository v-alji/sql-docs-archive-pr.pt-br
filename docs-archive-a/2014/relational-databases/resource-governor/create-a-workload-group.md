...
##  <a name="create-a-workload-group-using-sql-server-management-studio"></a><a name="CreWGProp"></a> Criar um grupo de cargas de trabalho usando o SQL Server Management Studio  
...
##  <a name="create-a-workload-group-using-transact-sql"></a><a name="CreWGTSQL"></a> Criar grupo de cargas de trabalho usando Transact-SQL  
