...
-   Determine espaço para o índice de mapeamento temporário.  
 ...
 Para obter mais informações sobre o índice de mapeamento temporário, veja [Requisitos de espaço em disco para operações de índice DDL](disk-space-requirements-for-index-ddl-operations.md).  
