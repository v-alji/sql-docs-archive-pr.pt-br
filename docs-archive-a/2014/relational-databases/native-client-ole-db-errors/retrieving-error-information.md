...
ms.locfileid: "87581789"
---
# <a name="retrieving-error-information"></a><span data-ttu-id="f21b4-102">Recuperando informações de erro</span><span class="sxs-lookup"><span data-stu-id="f21b4-102">Retrieving Error Information</span></span>
  <span data-ttu-id="f21b4-103">Este exemplo obtém informações das várias interfaces de erro expostas pelo [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] provedor de OLE DB de cliente nativo.</span><span class="sxs-lookup"><span data-stu-id="f21b4-103">This example obtains information from the various error interfaces exposed by the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="f21b4-104">Consulte Também</span><span class="sxs-lookup"><span data-stu-id="f21b4-104">See Also</span></span>  
 [<span data-ttu-id="f21b4-105">Erros</span><span class="sxs-lookup"><span data-stu-id="f21b4-105">Errors</span></span>](errors.md)  
