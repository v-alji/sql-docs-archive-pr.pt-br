...
#### <a name="cascading-referential-integrity"></a>Integridade referencial em cascata
 ...
 NENHUMA ação [!INCLUDE[ssDE](../../includes/ssde-md.md)] gera um erro e a ação excluir ou atualizar na linha na tabela pai é revertida.
