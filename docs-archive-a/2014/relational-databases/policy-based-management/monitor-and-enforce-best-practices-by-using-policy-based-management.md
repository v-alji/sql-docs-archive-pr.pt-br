...
|Verificação de Página de Banco de Dados|[Definir a opção de banco de dados PAGE_VERIFY como CHECKSUM](set-the-page-verify-database-option-to-checksum.md)|  
