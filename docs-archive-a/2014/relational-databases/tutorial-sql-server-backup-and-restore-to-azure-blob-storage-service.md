...
## <a name="what-you-will-learn"></a>O que você aprenderá  
 ...
 [Lição 3: Gravar um backup de banco de dados completo no serviço de Armazenamento de Blobs](../tutorials/lesson-3-write-a-full-database-backup-to-the-windows-azure-blob-storage-service.md)  
