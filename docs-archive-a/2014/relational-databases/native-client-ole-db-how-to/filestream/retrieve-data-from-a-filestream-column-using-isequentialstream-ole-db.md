...
ms.locfileid: "87581783"
---
# <a name="retrieve-data-from-a-filestream-column-using-isequentialstream-ole-db"></a><span data-ttu-id="ef036-102">Recuperar dados de uma coluna FILESTREAM usando ISequentialStream (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="ef036-102">Retrieve Data from a FILESTREAM Column Using ISequentialStream (OLE DB)</span></span>
  <span data-ttu-id="ef036-103">Este exemplo mostra como usar uma interface ISequentialStream em uma interface ICommandText para recuperar um único registro de uma coluna Filestream.</span><span class="sxs-lookup"><span data-stu-id="ef036-103">This sample shows uses an ISequentialStream interface in an ICommandText interface to retrieve a single record from a Filestream column.</span></span>  
  
 <span data-ttu-id="ef036-104">Para obter mais informações sobre o recurso FileStream, consulte [suporte a filestream &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="ef036-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="ef036-105">Exemplo</span><span class="sxs-lookup"><span data-stu-id="ef036-105">Example</span></span>  
 <span data-ttu-id="ef036-106">Verifique se a variável de ambiente INCLUDE inclui o diretório que contém sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="ef036-106">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="ef036-107">Use um dos exemplos a seguir para criar a tabela a ser lida pelo exemplo:</span><span class="sxs-lookup"><span data-stu-id="ef036-107">Use one of the following samples to create the table that this sample reads from:</span></span>  
  
-   [<span data-ttu-id="ef036-108">Enviar dados para uma coluna FILESTREAM usando ISequentialStream associado ao parâmetro ICommandText &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="ef036-108">Send Data to a FILESTREAM Column Using ISequentialStream Bound to ICommandText Parameter &#40;OLE DB&#41;</span></span>](send-data-to-filestream-isequentialstream-bound-to-icommandtext.md)  
  
-   [<span data-ttu-id="ef036-109">Enviar dados para uma coluna FILESTREAM usando IRowsetFastUpload &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="ef036-109">Send Data to a FILESTREAM Column Using IRowsetFastUpload &#40;OLE DB&#41;</span></span>](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
  
 <span data-ttu-id="ef036-110">Copie a primeira listagem de código e cole-a em um arquivo denominado ISSHelper.h.</span><span class="sxs-lookup"><span data-stu-id="ef036-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="ef036-111">Copie a segunda listagem de código e cole-a em um arquivo denominado ISSHelper.cpp.</span><span class="sxs-lookup"><span data-stu-id="ef036-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="ef036-112">Copie a terceira listagem de código e cole em um arquivo denominado ICommandDownload.cpp.</span><span class="sxs-lookup"><span data-stu-id="ef036-112">Copy the third code listing and paste it into a file called ICommandDownload.cpp.</span></span>  
  
 <span data-ttu-id="ef036-113">Compile ICommandDownload.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="ef036-113">Compile ICommandDownload.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="ef036-114">Quando este exemplo é executado, você deve transmitir um nome de servidor (ou servidor\nome_da_instância).</span><span class="sxs-lookup"><span data-stu-id="ef036-114">When this sample is run, you must pass a server name (or server\instance_name).</span></span>  
