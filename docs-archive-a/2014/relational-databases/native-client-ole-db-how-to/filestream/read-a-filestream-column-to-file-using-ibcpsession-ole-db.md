...
-   [Enviar dados para uma coluna FILESTREAM usando IRowsetFastUpload &#40;OLE DB&#41;](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
 ...
 Copie a terceira listagem de código e cole-a em um arquivo denominado IBCPSession.cpp.  
  
 Compile IBCPSession.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.  
  
 Quando este exemplo é executado, é necessário passar um nome de servidor (ou servidor\nome_da_instância) e um nome para o arquivo de formato que ele criará.  
