...
ms.locfileid: "87572980"
---
# <a name="send-data-to-a-filestream-column-using-irowsetfastupload-ole-db"></a><span data-ttu-id="4c9d7-102">Enviar dados para uma coluna FILESTREAM usando IRowsetFastUpload (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="4c9d7-102">Send Data to a FILESTREAM Column Using IRowsetFastUpload (OLE DB)</span></span>
  <span data-ttu-id="4c9d7-103">Este exemplo usa a interface IRowsetFastUpload para enviar entre 4 MB e 4 GB de dados a uma coluna filestream.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-103">This sample uses the IRowsetFastUpload interface to send between 4MB and 4GB of data to a filestream column.</span></span>  
  
 <span data-ttu-id="4c9d7-104">Para obter mais informações sobre o recurso FileStream, consulte [suporte a filestream &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="4c9d7-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="4c9d7-105">Exemplo</span><span class="sxs-lookup"><span data-stu-id="4c9d7-105">Example</span></span>  
 <span data-ttu-id="4c9d7-106">Antes de compilar e executar este exemplo, habilite o suporte a FILESTREAM ([Habilitar e configurar o FILESTREAM](../../blob/enable-and-configure-filestream.md)).</span><span class="sxs-lookup"><span data-stu-id="4c9d7-106">Before you compile and run this sample, enable FILESTREAM support ([Enable and Configure FILESTREAM](../../blob/enable-and-configure-filestream.md)).</span></span>  
  
 <span data-ttu-id="4c9d7-107">Verifique se a variável de ambiente INCLUDE inclui o diretório que contém sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-107">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="4c9d7-108">O servidor deve ter o diretório C:\DBFsa; é onde o exemplo criará o banco de dados.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-108">The server must have a directory called C:\DBFsa; this is where the sample will create the database.</span></span> <span data-ttu-id="4c9d7-109">Sua instância do [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] deve ter acesso de gravação neste local (por exemplo, faça logon como uma conta de sistema local).</span><span class="sxs-lookup"><span data-stu-id="4c9d7-109">Your instance of [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] must have write access to this location (for example, log on as a local system account).</span></span>  
  
 <span data-ttu-id="4c9d7-110">Copie a primeira listagem de código e cole-a em um arquivo denominado ISSHelper.h.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="4c9d7-111">Copie a segunda listagem de código e cole-a em um arquivo denominado ISSHelper.cpp.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="4c9d7-112">Copie a terceira listagem de código e cole-a em um arquivo denominado IRowsetFastLoadUpload.cpp.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-112">Copy the third code listing and paste it into a file called IRowsetFastLoadUpload.cpp.</span></span>  
  
 <span data-ttu-id="4c9d7-113">Compile IRowsetFastLoadUpload.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-113">Compile IRowsetFastLoadUpload.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="4c9d7-114">Ao executar este exemplo, você precisará passar o nome de um servidor ou de um servidor\nome_da_instância, bem como um valor entre 4 MB (0x400001) e 4 GB (0xFFFFFFFF) que indique a quantidade de dados a ser gravada.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-114">When you run this sample, you must pass the name of a server, or a server\instance_name, as well as a value between 4 MB (0x400001) and 4 GB (0xFFFFFFFF) indicating the amount of data to write.</span></span>  
  
 <span data-ttu-id="4c9d7-115">A quarta listagem de código ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) exclui o banco de dados criado por este exemplo.</span><span class="sxs-lookup"><span data-stu-id="4c9d7-115">The fourth ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) code listing deletes the database created by this sample.</span></span>  
