...
ms.locfileid: "87572983"
---
# <a name="send-data-to-a-filestream-column-using-isequentialstream-bound-to-icommandtext-parameter-ole-db"></a><span data-ttu-id="0d6c4-102">Enviar dados para uma coluna FILESTREAM por meio de ISequentialStream associado ao parâmetro ICommandText (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="0d6c4-102">Send Data to a FILESTREAM Column Using ISequentialStream Bound to ICommandText Parameter (OLE DB)</span></span>
  <span data-ttu-id="0d6c4-103">Este exemplo usa uma interface de ISequentialStream associada a um parâmetro de ICommandText para enviar de 4 MB a 4 GB de dados a uma coluna de filestream.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-103">This sample uses an ISequentialStream interface bound to an ICommandText parameter to send between 4MB and 4GB of data to a filestream column.</span></span>  
  
 <span data-ttu-id="0d6c4-104">Para obter mais informações sobre o recurso FileStream, consulte [suporte a filestream &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="0d6c4-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="0d6c4-105">Exemplo</span><span class="sxs-lookup"><span data-stu-id="0d6c4-105">Example</span></span>  
 <span data-ttu-id="0d6c4-106">Antes de compilar e executar este exemplo, habilite o suporte a FILESTREAM ([Habilitar e configurar o FILESTREAM](../../blob/enable-and-configure-filestream.md)).</span><span class="sxs-lookup"><span data-stu-id="0d6c4-106">Before you compile and run this sample, enable FILESTREAM support ([Enable and Configure FILESTREAM](../../blob/enable-and-configure-filestream.md)).</span></span>  
  
 <span data-ttu-id="0d6c4-107">Verifique se a variável de ambiente INCLUDE inclui o diretório que contém sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-107">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="0d6c4-108">O servidor deve ter o diretório C:\DBFsa; é onde o exemplo criará o banco de dados.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-108">The server must have a directory called C:\DBFsa; this is where the sample will create the database.</span></span> <span data-ttu-id="0d6c4-109">Sua instância do [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] deve ter acesso de gravação neste local (por exemplo, faça logon como uma conta de sistema local).</span><span class="sxs-lookup"><span data-stu-id="0d6c4-109">Your instance of [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] must have write access to this location (for example, log on as a local system account).</span></span>  
  
 <span data-ttu-id="0d6c4-110">Copie a primeira listagem de código e cole-a em um arquivo denominado ISSHelper.h.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="0d6c4-111">Copie a segunda listagem de código e cole-a em um arquivo denominado ISSHelper.cpp.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="0d6c4-112">Copie a terceira listagem de código e cole em um arquivo denominado ICommandUpload.cpp.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-112">Copy the third code listing and paste it into a file called ICommandUpload.cpp.</span></span>  
  
 <span data-ttu-id="0d6c4-113">Compile ICommandUpload.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-113">Compile ICommandUpload.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="0d6c4-114">Ao executar este exemplo, você precisará passar o nome de um servidor ou de um servidor\nome_da_instância, bem como um valor entre 4 MB (0x400001) e 4 GB (0xFFFFFFFF) que indique a quantidade de dados a ser gravada.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-114">When you run this sample, you must pass the name of a server, or a server\instance_name, as well as a value between 4 MB (0x400001) and 4 GB (0xFFFFFFFF) indicating the amount of data to write.</span></span>  
  
 <span data-ttu-id="0d6c4-115">A quarta listagem de código ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) exclui o banco de dados criado por este exemplo.</span><span class="sxs-lookup"><span data-stu-id="0d6c4-115">The fourth ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) code listing deletes the database created by this sample.</span></span>  
