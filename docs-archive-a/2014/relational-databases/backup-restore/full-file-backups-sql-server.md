...
# <a name="full-file-backups-sql-server"></a>Backups completos de arquivos (SQL Server)
 ...
 Um backup de arquivo pode servir como a *base diferencial* para backups de arquivos diferenciais. Para obter mais informações, veja [Backups diferenciais &#40;SQL Server&#41;](differential-backups-sql-server.md).  
