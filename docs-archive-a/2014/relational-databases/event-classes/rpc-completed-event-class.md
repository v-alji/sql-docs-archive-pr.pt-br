...
|Leituras|`bigint`|Número de leituras de página emitido pela chamada de procedimento remoto.|16|Sim|  
...
|Gravações|`bigint`|Número de gravações de página emitido pela chamada de procedimento remoto.|17|Sim|  
