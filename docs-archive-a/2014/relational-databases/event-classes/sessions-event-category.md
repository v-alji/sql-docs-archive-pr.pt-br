...
---
# <a name="sessions-event-category"></a>Categoria de evento Sessions
  A categoria de evento **Sessions** contém a classe de evento **ExistingConnection** .  
  
## <a name="in-this-section"></a>Nesta seção  
  
|Tópico|DESCRIÇÃO|  
|-----------|-----------------|  
|[Classe de evento ExistingConnection](existingconnection-event-class.md)|Indica as propriedades das conexões de usuário existentes quando o rastreamento foi iniciado.|  
