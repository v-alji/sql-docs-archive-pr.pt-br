...
## <a name="audit-dbcc-event-class-data-columns"></a>Colunas de dados da classe de evento Audit DBCC  
...
|**ColumnPermissions**|**int**|Indica se uma permissão de coluna foi definida ou não. Analise o texto da instrução para determinar exatamente quais permissões foram aplicadas a quais colunas.|44|Sim|  
...
||||||  
|**EventClass**|**int**|Tipo de evento = 116.|27|Não|  
...
||||||  
||||||  
|**TextData**|**ntext**|Texto SQL do comando DBCC.|1|Sim|  
