...
|Tópico|DESCRIÇÃO|  
|-----------|-----------------|  
|[Classe de evento Progress Report: Online Index Operation](progress-report-online-index-operation-event-class.md)|Indica o progresso de uma operação de compilação de índices online.|  
