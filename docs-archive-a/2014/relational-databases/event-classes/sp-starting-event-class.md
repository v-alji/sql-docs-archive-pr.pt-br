...
|EventClass|`int`|Tipo de evento = 42.|27|Não|  
...
|ObjectName|`nvarchar`|Nome do procedimento armazenado que está sendo iniciado.|34|Sim|  
|ObjectType|`int`|O tipo de procedimento armazenado que está sendo iniciado. Esse valor corresponde à coluna do tipo na exibição do catálogo sys.objects. Para obter valores, consulte [Coluna de evento de rastreamento ObjectType](objecttype-trace-event-column.md).|28|Sim|  
...
|TextData|`ntext`|Texto da chamada de procedimento.|1|Sim|  
