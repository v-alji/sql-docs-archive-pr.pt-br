...
|Texto da mensagem|Não é possível acessar a pasta de perfil de usuário dos dados do aplicativo local (%% LOCALAPPDATA%%).|  
  
## <a name="explanation"></a>Explicação  
 Não é possível recuperar um perfil de usuário.  
