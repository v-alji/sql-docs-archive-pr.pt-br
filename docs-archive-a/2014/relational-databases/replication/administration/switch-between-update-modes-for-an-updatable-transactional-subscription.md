...
2.  [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
 ...
 Para obter mais informações sobre como acessar a caixa de diálogo **Propriedades da Assinatura – \<Publisher>: \<PublicationDatabase>** , confira [Exibir e modificar propriedades de assinatura pull](../view-and-modify-pull-subscription-properties.md).  
