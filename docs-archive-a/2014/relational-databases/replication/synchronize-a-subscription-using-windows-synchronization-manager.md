...
1.  Na página **Geral** da caixa de diálogo **Propriedades de Assinatura – \<Subscriber>: \<SubscriptionDatabase>** , selecione um valor de **Habilitar** para a opção **Usar o Gerenciador de Sincronização do Windows**.  
...
1.  Inicie o Gerenciador de Sincronização usando um dos seguintes métodos:  
    ...
    -   Clique em **Iniciar**e, então, clique em **Executar** Na caixa de diálogo **executar** , digite `mobsync.exe` no campo **abrir** e, em seguida, clique em **OK**.  
