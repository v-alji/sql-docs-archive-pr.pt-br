...
4.  Na caixa de diálogo **nova função de servidor –**_server_role_name_ , na página **geral** , insira um nome para a nova função de servidor na caixa **nome da função de servidor** .  
