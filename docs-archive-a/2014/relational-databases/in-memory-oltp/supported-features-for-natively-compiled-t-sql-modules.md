...
##  <a name="auditing"></a><a name="auditing"></a> Auditoria  
 ...
 Para obter mais informações sobre a auditoria, consulte [Criar uma especificação de auditoria de banco de dados e de servidor](../security/auditing/create-a-server-audit-and-database-audit-specification.md).  
