...
ms.locfileid: "87575055"
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="5191e-102">Referência de LocalDB do SQL Server Express</span><span class="sxs-lookup"><span data-stu-id="5191e-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="5191e-103">Esta seção contém informações sobre o LocalDB do SQL Server Express:</span><span class="sxs-lookup"><span data-stu-id="5191e-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="5191e-104">Referência de mensagem de erro de LocalDB do SQL Server Express</span><span class="sxs-lookup"><span data-stu-id="5191e-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="5191e-105">Referência de API da instância de LocalDB do SQL Server Express</span><span class="sxs-lookup"><span data-stu-id="5191e-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="5191e-106">Exemplo de código</span><span class="sxs-lookup"><span data-stu-id="5191e-106">Code Sample</span></span>  
 <span data-ttu-id="5191e-107">O exemplo a seguir demonstra a API LocalDB.</span><span class="sxs-lookup"><span data-stu-id="5191e-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="5191e-108">Verifique se o LocalDB está instalado no computador antes de executar esse exemplo.</span><span class="sxs-lookup"><span data-stu-id="5191e-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="5191e-109">Você pode instalar o LocalDB na instalação no [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span><span class="sxs-lookup"><span data-stu-id="5191e-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
