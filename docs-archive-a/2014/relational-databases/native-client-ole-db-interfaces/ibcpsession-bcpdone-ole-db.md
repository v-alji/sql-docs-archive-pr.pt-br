...
ms.locfileid: "87582449"
---
# <a name="ibcpsessionbcpdone-ole-db"></a><span data-ttu-id="c7028-102">IBCPSession::BCPDone (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="c7028-102">IBCPSession::BCPDone (OLE DB)</span></span>
  <span data-ttu-id="c7028-103">Confirma as linhas restantes a serem enviadas ao [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].</span><span class="sxs-lookup"><span data-stu-id="c7028-103">Commits the remaining rows to be sent to [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].</span></span>  
  
## <a name="syntax"></a><span data-ttu-id="c7028-104">Sintaxe</span><span class="sxs-lookup"><span data-stu-id="c7028-104">Syntax</span></span>  
...
## <a name="remarks"></a><span data-ttu-id="c7028-105">Comentários</span><span class="sxs-lookup"><span data-stu-id="c7028-105">Remarks</span></span>  
 <span data-ttu-id="c7028-106">Nenhuma outra operação pode ser chamada na interface [IBCPSession](ibcpsession-ole-db.md) após a chamada ao método **BCPDone**.</span><span class="sxs-lookup"><span data-stu-id="c7028-106">No other operation can be called on the [IBCPSession](ibcpsession-ole-db.md) interface after calling the **BCPDone** method.</span></span> <span data-ttu-id="c7028-107">A única possibilidade é chamar o método [IBCPSession::BCPInit](ibcpsession-bcpinit-ole-db.md) para iniciar uma nova operação de cópia em massa.</span><span class="sxs-lookup"><span data-stu-id="c7028-107">The only possibility is to call the [IBCPSession::BCPInit](ibcpsession-bcpinit-ole-db.md) method to initiate a new bulk copy operation.</span></span> <span data-ttu-id="c7028-108">Isso é semelhante à chamada ao método [IRowsetFastLoad::Commit](irowsetfastload-commit-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="c7028-108">This is similar to calling the [IRowsetFastLoad::Commit](irowsetfastload-commit-ole-db.md) method.</span></span>  
  
## <a name="return-code-values"></a><span data-ttu-id="c7028-109">Valores do código de retorno</span><span class="sxs-lookup"><span data-stu-id="c7028-109">Return Code Values</span></span>  
 <span data-ttu-id="c7028-110">S_OK</span><span class="sxs-lookup"><span data-stu-id="c7028-110">S_OK</span></span>  
 <span data-ttu-id="c7028-111">O método foi bem-sucedido.</span><span class="sxs-lookup"><span data-stu-id="c7028-111">The method succeeded.</span></span>  
  
 <span data-ttu-id="c7028-112">E_UNEXPECTED</span><span class="sxs-lookup"><span data-stu-id="c7028-112">E_UNEXPECTED</span></span>  
 <span data-ttu-id="c7028-113">A chamada para o método era inesperada.</span><span class="sxs-lookup"><span data-stu-id="c7028-113">The call to the method was unexpected.</span></span> <span data-ttu-id="c7028-114">Por exemplo, o método **BCPInit** não foi chamado antes da chamada desse método.</span><span class="sxs-lookup"><span data-stu-id="c7028-114">For example, the **BCPInit** method was not called before calling this method.</span></span>  
  
## <a name="example"></a><span data-ttu-id="c7028-115">Exemplo</span><span class="sxs-lookup"><span data-stu-id="c7028-115">Example</span></span>  
 <span data-ttu-id="c7028-116">Este exemplo mostra como usar a interface **IBCPSession** .</span><span class="sxs-lookup"><span data-stu-id="c7028-116">This sample shows how to use the **IBCPSession** interface.</span></span>  
  
 <span data-ttu-id="c7028-117">O [!INCLUDE[tsql](../../includes/tsql-md.md)] a seguir deve ser executado antes de executar este exemplo:</span><span class="sxs-lookup"><span data-stu-id="c7028-117">The following [!INCLUDE[tsql](../../includes/tsql-md.md)] must be executed before running this sample:</span></span>  
...
```  
 ...
 <span data-ttu-id="c7028-118">O exemplo conecta-se ao banco de dados mestre.</span><span class="sxs-lookup"><span data-stu-id="c7028-118">The sample connects to the master database.</span></span>  
  
 <span data-ttu-id="c7028-119">Quando o exemplo é executado, ele cria outfile.dat no diretório do projeto.</span><span class="sxs-lookup"><span data-stu-id="c7028-119">When the sample runs, it creates outfile.dat in the project directory.</span></span> <span data-ttu-id="c7028-120">O outfile.dat contém os dados copiados da tabela em modo nativo (binário).</span><span class="sxs-lookup"><span data-stu-id="c7028-120">The outfile.dat contains the data copied from the table in native (binary) mode.</span></span>  
  
 <span data-ttu-id="c7028-121">Você pode usar BCP para adicionar estes dados novamente à tabela com o comando a seguir:</span><span class="sxs-lookup"><span data-stu-id="c7028-121">You could use BCP to add this data back into the table with the following command:</span></span>  
  
 <span data-ttu-id="c7028-122">**bcp master..fltest in outfile.dat -n -T -S** *servidor*</span><span class="sxs-lookup"><span data-stu-id="c7028-122">**bcp master..fltest in outfile.dat -n -T -S** *server*</span></span>  
  
 <span data-ttu-id="c7028-123">É necessário especificar sqlncli11.lib ao compilar este exemplo.</span><span class="sxs-lookup"><span data-stu-id="c7028-123">You will need to specify sqlncli11.lib when compiling this sample.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="c7028-124">Consulte Também</span><span class="sxs-lookup"><span data-stu-id="c7028-124">See Also</span></span>  
 <span data-ttu-id="c7028-125">[IBCPSession &#40;OLE DB&#41;](ibcpsession-ole-db.md) </span><span class="sxs-lookup"><span data-stu-id="c7028-125">[IBCPSession &#40;OLE DB&#41;](ibcpsession-ole-db.md) </span></span>  
 [<span data-ttu-id="c7028-126">Executando operações de cópia em massa</span><span class="sxs-lookup"><span data-stu-id="c7028-126">Performing Bulk Copy Operations</span></span>](../native-client/features/performing-bulk-copy-operations.md)  
