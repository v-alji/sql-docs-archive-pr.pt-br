...
6.  No painel **modelo de mineração** , selecione a tabela aninhada `v Assoc Seq Line Items` e arraste-a para a grade, para a caixa **critérios/argumento** da função **PredictSequence** .  
...
2.  Na caixa de diálogo **entrada de consulta singleton** , clique na caixa **valor** para `Region` e selecione **Europa**.  
...
5.  Na caixa de diálogo **entrada de consulta singleton** , clique na caixa **valor** para e `Region` selecione **América do Norte**.  
...
2.  Na caixa de diálogo **entrada de consulta singleton** , clique na caixa **valor** para e `Region` Selecione a linha vazia para limpar a entrada desse campo.  
  
3.  Na caixa de diálogo **entrada de consulta singleton** , clique na caixa **valor** para e, em `vAssocSeqLineItems` seguida, clique no botão (...).  
