...
1.  Clique com o botão direito do mouse `Pacific Cluster` , selecione **detalhar**e, em seguida, selecione **colunas de modelo e estrutura**.  
...
1.  Clique com o botão direito do mouse na linha **modelo** na coluna do cluster `Largest Cluster` e selecione **Mostrar Legenda**.  
...
4.  Clique com o botão direito do mouse no histograma colorido na `Region` linha para `Pacific Cluster` , selecione **detalhar**e selecione **apenas colunas de modelo**.  
