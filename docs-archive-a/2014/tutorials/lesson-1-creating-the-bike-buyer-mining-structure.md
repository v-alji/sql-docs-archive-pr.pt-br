...
```  
 ...
 Você pode usar a função DISCRETIZAR no \<mining structure columns> para discretizar colunas contínuas usando a seguinte sintaxe:  
...
2.  Na caixa de diálogo **conectar ao servidor** , para **tipo de servidor**, selecione **Analysis Services**. Em **nome do servidor**, digite `LocalHost` ou digite o nome da instância do à qual [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] você deseja se conectar para esta lição. Clique em **Conectar**.  
  
3.  No Pesquisador de **objetos**, clique com o botão direito do mouse na instância do [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] , aponte para **nova consulta**e clique em **DMX** para abrir o **Editor de consultas** e uma nova consulta em branco.  
