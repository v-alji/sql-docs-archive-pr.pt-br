...
##  <a name="creating-the-new-extended-sales-data"></a><a name="bkmk_newExtendData"></a>Criando os novos dados de vendas estendidos  
...
###  <a name="create-a-data-source-view-using-the-new-sales-data"></a><a name="bkmk_newReplaceData"></a>Criar uma exibição da fonte de dados usando os novos dados de vendas  
...
9. Clique com o botão direito do mouse na `AllRegions` tabela e selecione **explorar dados**.  
  
###  <a name="to-create-the-series-data-for-cross-prediction"></a><a name="bkmk_CrossData"></a>Para criar os dados de série para previsão cruzada  
