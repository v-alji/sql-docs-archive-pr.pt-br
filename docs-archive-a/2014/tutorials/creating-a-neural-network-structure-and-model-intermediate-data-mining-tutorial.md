...
11. Selecione a **chave**, a **entrada**e as `Predict` caixas de seleção, conforme mostrado na tabela a seguir:  
...
15. Para o **nome do modelo de mineração**, digite `Call Center Default NN` e clique em **concluir**.  
...
-   **Guardar por áreas iguais**  
 ...
 Como alternativa, em vez de usar os valores numéricos, você pode adicionar uma coluna derivada separada que classifica as notas de serviço em intervalos de destino predefinidos, como **melhor** (ServiceGrade \<= 0.05), **Acceptable** (0.10 > ServiceGrade > 0, 5) e **ruim** (ServiceGrade >= 0,10).  
...
4.  Na caixa de diálogo **novo modelo de mineração** , para **nome do modelo**, digite `Call Center Binned NN` . Na lista suspensa **nome do algoritmo** , selecione **rede neural da Microsoft**.  
