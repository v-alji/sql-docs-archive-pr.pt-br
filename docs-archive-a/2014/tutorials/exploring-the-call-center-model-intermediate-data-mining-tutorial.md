...
### <a name="using-the-variables-pane"></a>Usando o painel Variáveis  
 Nesse modelo, parece que se `Average Time Per Issue` trata de um fator importante. Essa variável indica o tempo médio necessário para que uma chamada seja atendida, independentemente do tipo de chamada.  
...
1.  No designer de mineração de dados, na guia **Visualizador do modelo de mineração** , selecione \<mining model name> .  
