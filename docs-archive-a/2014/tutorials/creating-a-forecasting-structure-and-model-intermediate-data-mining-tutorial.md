...
12. Na página **concluindo o assistente** , para **nome da estrutura de mineração**, digite `Forecasting` .  
  
    > [!NOTE]  
    >  A opção para habilitar o detalhamento não estará disponível para modelos de série temporal.  
  
13. Em **nome do modelo de mineração**, digite `Forecasting` e clique em **concluir**.  
  
     O designer de mineração de dados é aberto para exibir a `Forecasting` estrutura de mineração que você acabou de criar.  
