...
2.  Substitua o código para o método `LoadReportDefinition()` no arquivo Program.cs (Module1.vb para o [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]) pelo seguinte código:  
