...
2.  Na caixa **Filtrar conjunto** , digite e, em `Touring Tire` seguida, clique fora da caixa.  
...
3.  Clique com o botão direito do mouse no item, `Touring Tire` selecione **detalhar**e, em seguida, selecione **colunas de modelo e estrutura**.  
