...
2.  Na caixa de diálogo **salvar resultado da consulta de mineração de dados** , para **fonte de dados**, selecione [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)] . Também será possível criar uma fonte de dados se você quiser salvar os dados em um banco de dados relacional diferente.  
