...
## <a name="returning-the-content-of-a-mining-model"></a>Retornando o conteúdo de um modelo de mineração  
 ...
 Veja a seguir um exemplo genérico de SELECT de \<model> . Instrução de conteúdo:  
...
2.  Copie o exemplo genérico de SELECT de \<model> . Instrução de conteúdo na consulta em branco.  
...
## <a name="use-drillthrough"></a>Use a análise  
 ...
 Veja a seguir um exemplo genérico de SELECT de \<model> . Instrução CASEs:  
...
2.  Copie o exemplo genérico de SELECT de \<model> . Instrução CASEs na consulta em branco.  
