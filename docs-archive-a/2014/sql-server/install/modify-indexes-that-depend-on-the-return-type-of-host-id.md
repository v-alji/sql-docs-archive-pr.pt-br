...
---
# <a name="modify-indexes-that-depend-on-the-return-type-of-host_id"></a>Modificar índices que dependem do tipo de retorno de HOST_ID
  A função HOST_ID agora retorna um `char(10)`.  
